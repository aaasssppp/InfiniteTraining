...
namespace CodeChallenge10_Question2.Models
{
    using System;
    ...
    public partial class NorthwindDBEntities : DbContext
    {
        ...
        [DbFunction("NorthwindDBEntities", "fun_GetEmp_ByCountry")]
        public virtual IQueryable<fun_GetEmp_ByCountry_Result> fun_GetEmp_ByCountry(string country)
        {
            var countryParameter = country != null ?
                new ObjectParameter("Country", country) :
                new ObjectParameter("Country", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fun_GetEmp_ByCountry_Result>("[NorthwindDBEntities].[fun_GetEmp_ByCountry](@Country)", countryParameter);
        }
